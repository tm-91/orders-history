        ...
        <main class="rwd-layout-width rwd-layout-container">
            <section class="rwd-layout-col-12">
                <div class="edition-form">
                    <p>Kategorie sklepu (<?php echo Application\App::escapeHtml($categories->count); ?>):</p>
                    <ul>
                        <?php
                        foreach ($categories as $c) {
                            ...
                            if (isset($c['translations'][$_locale])) {
                                ...
                                <li>
                                    ...
                                    echo Application\App::escapeHtml($c->translations->$_locale->name); ?>

                                    (id: <?php echo Application\App::escapeHtml($c['category_id']); ?>)
                                </li>
                            <?php
                            }
                        }
